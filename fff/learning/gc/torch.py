"""Implementations of core operations of SchNet in torch"""
import torch
import scipy.spatial


# TODO (wardlt): Add a CUDA implementation
...
def knn(x, y, k, batch_x=None, batch_y=None, boxsize=None):
    ...
    tree = scipy.spatial.cKDTree(x.detach().numpy(), boxsize=[1.000001] * 4)  # TODO (wardlt): Wrong. Normalization throws things off
    dist, col = tree.query(
